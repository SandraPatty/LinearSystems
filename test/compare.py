...
plt.legend(['Метод простых итераций', 'Метод Якоби', 'Метод Гаусса-Зейделя', 'Ускорение Гаусса-Зейделя',
 'Метод симметризованного Гаусса-Зейделя', 'Метод быстрого спуска', 'Чебышевское ускорение', 'Метод сопряженнных градиентов'], loc='lower right',  fontsize="8")
plt.yscale('log')
